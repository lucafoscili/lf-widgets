...
export const getFrameworkFixtures = (): LfShowcaseFixture => {
  //#region example map
            ...
            children: [
              {
                children: [
                  ...
                  },
                  {
                    id: DOC_IDS.content,
                    value:
                      " is the main framework class. It handles various aspects of the library, including assets, colors, data management, debugging, portal management, theming, and utility functions.",
                  },
                  {
                    id: DOC_IDS.content,
                    value:
                      "This module, along with its submodules, provides a comprehensive set of tools for managing and manipulating data, assets, and UI elements in a component-agnostic manner.",
                  },
                ],
