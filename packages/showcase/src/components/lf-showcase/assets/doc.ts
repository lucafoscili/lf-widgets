  ...
  "lf-textfield": {
    ...
    props: [
      ...
      },
      {
        ...
        type: '"--lf-icon-image" | "--lf-icon-upload" | "--lf-icon-delete" | "--lf-icon-danger" | "--lf-icon-disabled" | "--lf-icon-info" | "--lf-icon-primary" | "--lf-icon-secondary" | "--lf-icon-success" | "--lf-icon-warning" | "--lf-icon-add" | "--lf-icon-attachment" | "--lf-icon-broken-image" | "--lf-icon-clear" | "--lf-icon-copy" | "--lf-icon-copy-ok" | "--lf-icon-collapsed" | "--lf-icon-download" | "--lf-icon-dropdown" | "--lf-icon-edit" | "--lf-icon-expanded" | "--lf-icon-loading" | "--lf-icon-minus" | "--lf-icon-next" | "--lf-icon-plus" | "--lf-icon-previous" | "--lf-icon-refresh" | "--lf-icon-settings" | "--lf-icon-search"',
      },
      {
        name: "lfUiSize",
        docs: "The size of the component.",
