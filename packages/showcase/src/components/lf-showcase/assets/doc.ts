...
export const LF_DOC: LfShowcaseDoc = {
  ...
  "lf-imageviewer": {
    ...
    props: [
      ...
      {
        name: "lfNavigationTree",
        docs: "Configuration options for the navigation tree.\r\nAccepts a boolean to toggle visibility or an object to customize layout.",
        type: "LfImageviewerNavigationTreeOptions | boolean",
      },
      {
        name: "lfStyle",
        docs: "Custom styling for the component.",
      ...
      {
        name: "lfTreeProps",
        docs: "Overrides the default tree props applied to the navigation tree instance.",
        type: '{ lfAccordionLayout?: boolean; lfDataset?: LfDataDataset; lfEmpty?: string; lfFilter?: boolean; lfInitialExpansionDepth?: number; lfGrid?: boolean; lfRipple?: boolean; lfSelectable?: boolean; lfStyle?: string; lfUiSize?: "small" | "large" | "medium" | "xlarge" | "xsmall" | "xxlarge" | "xxsmall"; }',
      },
      {
        name: "lfValue",
