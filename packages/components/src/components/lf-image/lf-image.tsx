...
export class LfImage implements LfImageInterface {
   ...
   * @remarks This state property is initialized using the debug.info.create() method from the lfCore instance.
   */
