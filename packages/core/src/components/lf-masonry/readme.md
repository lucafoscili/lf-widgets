...
| `--lf-masonry-capture-border-radius`   | Sets the border radius for the capture overlay. Defaults to => 4px                                                                                     |
| `--lf-masonry-capture-selected-border` | Sets the border for the selected capture item. Defaults to => 2px solid rgba(var(--lf-color-secondary), 0.875)                                         |
| `--lf-masonry-capture-selected-filter` | Sets the filter for the selected capture item. Defaults to => brightness(110%) drop-shadow(0 0 0.5em rgb(var(--lf-color-secondary)))                   |
| `--lf-masonry-chart-min-height`        | Sets the minimum height for the chart inside the capture. Defaults to => 150px                                                                         |
...
| `--lf-masonry-grid-overflow`           | Sets the overflow for the grid of the masonry component. Defaults to => auto                                                                           |
