...
| `--lf-checkbox-color-on-primary`       | Color for content on primary backgrounds. Defaults to => var(--lf-state-on-primary, var(--lf-color-on-primary))          |
| `--lf-checkbox-color-primary`          | Primary color for checked/active states. Defaults to => var(--lf-state-primary, var(--lf-color-primary))                 |
| `--lf-checkbox-color-surface`          | Surface/track background color. Defaults to => var(--lf-state-surface, var(--lf-color-surface)) Layout/sizing variables: |
