...
| `lfInline`         | `lf-inline`     | When true, renders the snackbar as an inline element instead of fixed position. Useful for showcasing or embedding snackbars within content flow. Note: Auto-dismiss is disabled when inline. | `boolean`                                                                                         | `false`                                                                               |
