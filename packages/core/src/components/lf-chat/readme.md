...
| `lfTypewriterProps` | --                    | Sets the props of the assistant typewriter component. Set this prop to false to replace the typewriter with a simple text element. | `LfTypewriterPropsInterface`                                                       | `{     lfDeleteSpeed: 10,     lfTag: "p",     lfSpeed: 20,   }`                         |
