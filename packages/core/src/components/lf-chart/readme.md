...
| `lfTypes`   | `lf-types`   | The type of the chart. Supported chart formats.                                                                                                                                | `("area" \| "line" \| "bar" \| "radar" \| "calendar" \| "scatter" \| "pie" \| "funnel" \| "sankey" \| "candlestick" \| "heatmap" \| "bubble" \| "gaussian" \| "hbar" \| "sbar")[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `["line"]` |
