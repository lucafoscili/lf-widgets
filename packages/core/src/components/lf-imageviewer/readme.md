...
| `lfNavigationTree` | `lf-navigation-tree` | Configuration options for the navigation tree. Accepts a boolean to toggle visibility or an object to customize layout.                | `LfImageviewerNavigationTreeOptions \| boolean`                                                                                                                                                                                                                                                                                                                                | `false` |
| `lfStyle`          | `lf-style`           | Custom styling for the component.                                                                                                      | `string`                                                                                                                                                                                                                                                                                                                                                                       | `""`    |
| `lfTreeProps`      | `lf-tree-props`      | Overrides the default tree props applied to the navigation tree instance.                                                              | `{ lfAccordionLayout?: boolean; lfDataset?: LfDataDataset; lfExpandedNodeIds?: string[]; lfEmpty?: string; lfFilter?: boolean; lfInitialExpansionDepth?: number; lfGrid?: boolean; lfSelectedNodeIds?: string[]; lfRipple?: boolean; lfSelectable?: boolean; lfStyle?: string; lfUiSize?: "small" \| "large" \| "medium" \| "xlarge" \| "xsmall" \| "xxlarge" \| "xxsmall"; }` | `{}`    |
