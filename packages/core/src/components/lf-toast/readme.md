...
| ----------------- | ------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `lfCloseCallback` | `lf-close-callback` | Callback invoked when the toast is closed.                                                                 | `(toast: LfToastInterface, e: PointerEvent, ...args: any[]) => any`                      | `(     _toast: LfToast,     _e: PointerEvent,   ) => {     this.unmount();   }` |
